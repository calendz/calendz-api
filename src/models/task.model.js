...
const taskSchema = new Schema({
  ...
  city: { type: String, enum: [null, 'Arras', 'Auxerre', 'Bordeaux', 'Brest', 'Grenoble', 'Lille', 'Lyon', 'Montpellier', 'Nantes', 'Rennes', 'Paris', 'Dakar'], required: false },
  grade: { type: String, enum: [null, 'B1', 'B2', 'B3', 'I1', 'I2', 'WIS1', 'WIS2', 'WIS3', 'WIS4', 'WIS5'], required: false },
