...
module.exports = class Task {
  constructor ({
    ...
    grade = faker.random.arrayElement(['B1', 'B2', 'B3', 'I1', 'I2', 'WIS1', 'WIS2', 'WIS3', 'WIS4', 'WIS5']),
    ...
    city = faker.random.arrayElement(['Arras', 'Auxerre', 'Bordeaux', 'Brest', 'Grenoble', 'Lille', 'Lyon', 'Montpellier', 'Nantes', 'Rennes', 'Paris', 'Dakar']),
    targets = []
  }) {
    this._id = _id
    this.author = author
